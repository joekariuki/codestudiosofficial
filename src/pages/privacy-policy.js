...
function PrivacyPolicyPage() {
  return (
    <Layout>
      <SEO
        keywords={[`The Code Studios`, `Privacy`, `Policy`]}
      ...
      <section className="container text-black body-font overflow-hidden">
        <div className="w-full">
          ...
          <div className="container py-12 lg:flex-grow flex flex-col md:items-start items-center text-left text-lg">
            <p className="mb-4">
              The Code Studios ( ) values its users&apos; privacy. This Privacy
              Policy (&quot;Policy&quot;) will help you understand how we
              ...
              what we will and will not do with the information we collect. Our
              Policy has been designed and created to ensure those affiliated
              with The Code Studios of our commitment and realization of our
            ...
            <p className="mb-4">
              ...
              any point in time The Code Studios decides to make use of any
            ...
            <p className="mb-4">
              This Policy applies to The Code Studios and any subsidiary company
              listed below, and it governs any and all data collection and usage
              by us. Through the use of thecodestudiosofficial.com and any
              subsidiary website listed below, you are therefore consenting to
              the data collection procedures expressed in this Policy.
            </p>
            <p className="mb-4">
              <span className="font-bold">Subsidiary Company: </span>
              Peyton, The Artist
            </p>
            <p className="mb-4">
              Please note that this Policy does not govern the collection and
              use of information by companies that The Code Studiosdoes not
            ...
            <h2 className="font-bold text-xl tracking-wide underline mb-4">
            ...
            <p className="mb-4">
              In addition, The Code Studios may have the occasion to collect
            ...
            <p className="mb-4">
              The Code Studios may also deem it necessary, from time to time, to
            ...
            <ul className="mb-4 list-disc list-inside">
              <li>
                ...
                services you have requested; · To fulfill our legitimate
            ...
            <p className="mb-4">
              The Code Studios does not now, nor will it in the future, sell,
              rent or lease any of its customer lists and/or names to any third
              parties.
            </p>

            <p className="mb-4">
              The Code Studios may collect and may make use of personal
              ...
              thecodestudiosofficial.com and its subsidiaries.
            </p>

            <p className="mb-4">
              The Code Studios and its subsidiaries may also be in contact with
              you with regards to completing surveys and/or research
              questionnaires related to your opinion of current or potential
              future services that may be offered. The Code Studiosuses various
              third-party social media features including but not limited to
              Instagram, Facebook, Twitter and other interactive programs. These
              ...
              providers and are not within The Code Studios&apos;s control.
            </p>
            ...
            <p className="mb-1">
              The Code Studios may not use or disclose the information provided
            ...
            <ul className="mb-4 list-disc list-inside">
              ...
              <li>
                ...
                and property of The Code Studios.
              </li>
            </ul>
            ...
            <p className="mb-4">
              The Code Studios greatly respects your privacy. We do maintain and
              reserve the right to contact you if needed for non-marketing
              purposes (such as bug alerts, security breaches, account issues,
              and/or changes in The Code Studios products and services). In
            ...
            <p className="mb-4">
              The Code Studios&apos;s website is not directed to, and does not
              ...
              steps to ensure that such information is deleted from our
              system&apos;s database, or in the alternative, that verifiable
              parental consent is obtained for the use and storage of such
              information. Anyone under the age of thirteen (13) must seek and
            ...
            <p className="mb-4">
              ...
              thecodestudiosofficial@gmail.com. If you wish to unsubscribe or
              opt-out from any third-party websites, you must go to that
              specific website to unsubscribe or opt-out. The Code Studios will
            ...
            <p className="mb-4">
              ...
              The Code Studios does not claim nor accept responsibility for any
            ...
            <p className="mb-4">
              The Code Studios&apos;s operations are located primarily in the
            ...
            <p className="mb-2">
              The Code Studios takes precautions to protect your information.
              ...
              and looking for &quot;https&quot; at the beginning of the address
              of the webpage
            </p>
            <p className="mb-4">
            ...
            <p className="mb-2">
              ...
              and acceptance of such changes. How to Contact Us If you have any
              questions or concerns regarding the Privacy Policy Agreement
              related to our website, please feel free to contact us at the
